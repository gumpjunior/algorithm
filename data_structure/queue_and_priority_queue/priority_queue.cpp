...
int main()
{
  ...
  functionC();
  // I did not understand how functionD works, so comment it out.
  // This program copied from link:
  // http://web.eecs.utk.edu/~leparker/Courses/CS302-Fall06/Notes/PQueues/priority.cpp
